...
import keshav from "../image/keshav_image.jpg"
import food_delivery from "../image/food_delivery.jpg"
import naveen from "../images/HeroImage.jpg"
export const Bio = {
  name: "Naveen Shekhar Mishra",
  roles: [
  ...
  gfg:"https://www.geeksforgeeks.org/user/naveen21sc5f79/",
};
...
export const education = [
  {
    id: 0,
    img: "https://th.bing.com/th/id/OIP.vyorKwhvcMFX8oDItVnMAAAAAA?rs=1&pid=ImgDetMain",
    school: "Galgotias University",
    date: "Oct 2021 - Sep 2025",
    grade: "8.30 CGPA",
    desc: "I am currently pursuing a Bachelor's degree in Computer Science and Engineering at Galgotias University Grater Noid. I have completed 6 semesters and have a CGPA of 8.30. I have taken courses in Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, among others.",
    degree: "Bachelor of Technology - BTech, Computer Science and Engineering",
  },
  {
    id: 1,
    img: "",
    school: "Gulab Memorial College, Bettiah",
    date: "Apr 2018 - Apr 2020",
    grade: "88.2%",
    desc: "I completed my class 12 high school education at Gulab Memorial College, Bettiah.",
    degree: "BSEB(XII), Science",
  },
  {
    id: 2,
    img: "",
    school: "High School Sathi",
    date: "Apr 2016 - Apr 2018",
    grade: "92.3%",
    desc: "I completed my class 9 and 10 education at High School Sathi, Sathi.",
    degree: "BSEB(X)",
  },
];
...
Our platform is fully responsive, providing an optimal experience on both mobile and desktop devices. The modern UI guarantees easy navigation and interaction. Deployed on Vercel for reliable hosting and managed on GitHub for collaboration and version control, our tutorial offers valuable insights for both beginners and experienced developers. Join us and elevate your web development skills by building a cutting-edge e-commerce platform!`,
    ...
    category: "web app",
    github: "https://github.com/naveenShekharGit/MERN_E_Commerce",
...
For database management, I utilized MongoDB, capitalizing on its flexibility and scalability to manage diverse data requirements. Secure payment integration was implemented with Razorpay, providing reliable transaction options for students purchasing courses. User authentication and password security were enforced using JWT tokens and bcrypt encryption, safeguarding sensitive information.

The platform allows students to buy and access courses, while teachers can create and teach courses. Admins have the ability to manage users and content, making this a comprehensive and robust e-learning solution. This project highlights my expertise in building scalable, secure, and user-friendly web applications.
`,
    image: studynotion,
    tags: ["React", "Redux", "Tailwind CSS", "Node js", "Express js", "MongoDB", "Rezorpay Payment Integration", "JWT authentication"],
    category: "web app",
    github: "https://github.com/naveenShekharGit/StudyNotion",
    webapp: "https://study-notion-frontend-rose.vercel.app/",
    member: [
      {
        name: "Naveen Shekhar Mishra",
        img: naveen,
      ...
      },
      {
        name: "Keshav",
        img: keshav,
        linkedin: "https://www.linkedin.com/in/keshav-kumar-096b43310?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ",
